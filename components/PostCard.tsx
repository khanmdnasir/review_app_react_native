...
export default function PostCard() {
  ...
  // Function to handle see more/see less toggle
  ...
  return (
    <View style={styles.postCard}>
        ...
        <View style={styles.userInfo}>
            <View style={styles.profileInfo}>
               <Image
                ...
                />
                <View>
                    <Text style={styles.userName}>Dianne Russell</Text>
        ...
        <View style={styles.tagsContainer}>
          {['LHR – DEL', 'Air India', 'Business Class', 'July 2023'].map((tag, index) => (
        ...
        <Text style={styles.postText}>
          {isTextExpanded
            ? 'Stay tuned for a smoother, more convenient experience right at your fingertips, a smoother, more convenient experience. A smoother, more convenient other, more convenient experience right at your fingertips, a smoother, more convenient other, more convenient experience right at your fingertips.' 
            : 'Stay tuned for a smoother, more convenient experience right at your fingertips, a smoother, more convenient...'}
        </Text>
        ...
        <View style={styles.likeCommentBar}>
          <TouchableOpacity style={styles.likeButton}>
            ...
            <Text style={{ marginLeft: 5}}>30 Like</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.commentButton}>
            <FontAwesome name="comment-o" size={20} color="black" />
            <Text style={{ marginLeft: 5}}>20 Comment</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.shareButton}>
            <FontAwesome name="share" size={20} color="black" />
            <Text style={{ marginLeft: 5}}>2 Share</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.commentSection}>
          ...
          <View style={styles.writeCommentSection}>
            <Image
              source={{ uri: 'https://randomuser.me/api/portraits/men/1.jpg' }}
              style={styles.writeCommentAvatar}
            />
            <TextInput
